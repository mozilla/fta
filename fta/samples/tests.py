...
PAGE_BEGIN = "<html lang=\"en-us\">" \
           "<head><meta charset=\"utf-8\"/>" \
           "<title>Title</title>"\
           "<body class=\"app-polls model-question change-list\">"
PAGE_END = "</body></html>"
SEARCH_FATHOM_LABEL = "<input data-fathom=\"search\" id =\"searchbar\" name=\"q\" type=\"text\" value=""/>"
EMAIL_FATHOM_LABEL = "<input data-fathom=\"email\" id=\"id2\" name=\"question_text\" type=\"text\" value=""/>"
...
def test_convert_fathom_sample_to_labeled_sample_2():
    page = PAGE_BEGIN + SEARCH_FATHOM_LABEL + EMAIL_FATHOM_LABEL + WITH_FTA_ID + PAGE_END
    labeled_sample, labels_to_fta_id = convert_fathom_sample_to_labeled_sample(page)
